...
$query->bindParam(':eid',$eid,PDO::PARAM_STR);
 $query->execute();
  echo "<script>document.addEventListener('DOMContentLoaded', function() { Swal.fire({title: 'Notification', text: 'Events details has been updated', icon: 'success', toast: true, position: 'top-end', showConfirmButton: false, timer: 3000, timerProgressBar: true}); });</script>";
}
...
{               ?>
                        <fieldset>
                           ...
                           <div class="field">
                              ...
                              <img loading="lazy" src="images/<?php echo $row->BannerImage;?>" width="100" height="100" value="<?php  echo $row->BannerImage;?>"><a href="changeimage.php?editid=<?php echo $row->ID;?>"> &nbsp; Edit Image</a>
                           </div>
