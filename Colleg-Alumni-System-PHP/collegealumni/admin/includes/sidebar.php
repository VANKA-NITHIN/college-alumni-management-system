               ...
               <div class="sidebar_blog_1">
                  ...
                  <div class="sidebar_user_info">
                     ...
                     <div class="user_profle_side">
                        <div class="user_img"><img loading="lazy" class="img-responsive" src="images/user_img.jpg" alt="#" /></div>
                        <div class="user_info">
                           <?php
$aid=$_SESSION['casaid'];
...
{               ?>
               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li>
                        <a href="#adminManage" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-user-secret red_color"></i> <span>Admins</span></a>
                        <ul class="collapse list-unstyled" id="adminManage">
                           <li><a href="add-admin.php">> <span>Add Admin</span></a></li>
                           <li><a href="manage-admins.php">> <span>Manage Admins</span></a></li>
                        </ul>
                     </li>
