               ...
               <div class="sidebar_blog_1">
                  <div class="sidebar-header">
                     <div class="logo_section">
                        <a href="index.html"><img loading="lazy" class="logo_icon img-responsive" src="images/logo/logo_icon.png" alt="#" /></a>
                     </div>
                  </div>
...
{               ?>
                        <div class="user_img"><img loading="lazy" class="img-responsive" src="images/<?php echo $row->Image;?>" alt="#" /></div>
                        <div class="user_info">
               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li><a href="view-events.php"><i class="fa fa-calendar purple_color"></i> <span>View Events</span></a></li>
                     <li><a href="alumni-directory.php"><i class="fa fa-users green_color"></i> <span>Alumni Directory</span></a></li>
                     <li><a href="manage-gallery.php"><i class="fa fa-image blue_color"></i> <span>Manage Gallery</span></a></li>
                     <li><a href="my-connections.php"><i class="fa fa-handshake-o orange_color"></i> <span>My Connections</span></a></li>
